...
sed -e '/PWD=/d' ${HOME}/birdnetpi/birdnet.conf > ${LOG_DIR}/birdnet.conf 
...
tar --remove-files -cvpzf ${HOME}/birdnetpi/logs.tar.gz ${LOG_DIR} &> /dev/null
# Finished
echo "Your compressed logs are located at ${HOME}/birdnetpi/logs.tar.gz"
